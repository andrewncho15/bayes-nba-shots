...
where \(u_j\) is the adjusted shooting ability of player \(j\), and \(\sigma_{\text{player}}\) describes how much true shooting ability varies across players after controlling for shot context.
